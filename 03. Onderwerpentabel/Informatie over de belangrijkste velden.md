...
:bulb: Wil je snel meer weten over onderwerp v1101\_t, ga dan naar [https://provincies.incijfers.be/viewer?var=v1101\_t](https://provincies.incijfers.be/viewer?var=v1101_t) of [https://provincies.incijfers.be/admin/viewer?var=v1101\_t](https://provincies.incijfers.be/admin/viewer?var=v1101_t). 

[Meer info over magisch bevragen van de Databank](https://provincies.incijfers.be/viewer?report=handleiding_abf).
