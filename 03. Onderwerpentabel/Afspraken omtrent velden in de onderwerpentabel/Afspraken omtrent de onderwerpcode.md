...
- Vervolgens gebruiken we een **viercijferige code**. De logica voor deze codes wordt bepaald in het _tabblad Domeinstructuur_ van het `opvolgingsbestand taakverdeling`.
