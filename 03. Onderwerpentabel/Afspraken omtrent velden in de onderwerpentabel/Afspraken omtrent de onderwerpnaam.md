# Afspraken omtrent de onderwerpnaam
...
| --- | --- | --- |
| promille[‰] | natuurlijk saldo
 (t.o.v. inwoners) | aantal geboorten min de sterfte per 1.000 inwoners |
...
| ratio\_1000[per 1.000] | pmeh met (enkel) IVT
 (t.o.v. 21-plussers) | aantal rechthebbenden op (enkel) een inkomensvervangende tegemoetkoming t.o.v. 1000 inwoners ouder dan 21 jaar [per 1000 21-plussers] |