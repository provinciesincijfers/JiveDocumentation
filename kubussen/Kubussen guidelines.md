...
Check de [beginnershandleiding](https://github.com/provinciesincijfers/JiveDocumentation/blob/master/kubussen/Basishandleiding%20kubussen.md)  eerst. Deze tekst bevat enkel aanvullende info.
